    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div
        ...
        style={{
          ...
          boxShadow: "0 20px 60px rgba(0,0,0,0.8), 0 0 50px rgba(56,189,248,0.18)",
        }}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-20 p-1.5 rounded-full text-slate-400 hover:text-white hover:bg-slate-800/80 transition-colors"
        ...
        >
          <div
            className="w-13 h-13 mx-auto mb-2 rounded-full flex items-center justify-center p-0.5"
            style={{
          ...
          <p className="text-[11px] mt-0.5 font-medium" style={{ color: "#38BDF8" }}>
            Sign In to Access Student &amp; Librarian Services
          </p>
        </div>
        ...
        <div className="p-5 space-y-4">
              ...
              <>
                <div>
                  ...
                  <p className="text-[10px] mt-1" style={{ color: "#64748B" }}>
                    ✓ Sign in or auto-create account with your Gmail
                  </p>
                </div>
          ...
          <div className="text-center pt-2">
            <button
              type="button"
              onClick={onClose}
              className="text-xs text-slate-400 hover:text-electric transition-colors"
            >
              Or continue browsing catalog as Guest →
            </button>
          </div>
        </div>
